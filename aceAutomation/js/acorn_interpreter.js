...
var ca = function (a) {
  function b(f) {
    return 48 > f
      ...
      : 123 > f
      ? !0
      : 170 <= f && Jc.test(String.fromCharCode(f));
  }
  function d(f) {
    return 65 > f
      ? 36 === f
      ...
      : 123 > f
      ? !0
      : 170 <= f && Pb.test(String.fromCharCode(f));
  }
  function c(f, g) {
    var l = r;
    for (var n = 1, w = 0; ; ) {
      Sa.lastIndex = w;
      var J = Sa.exec(l);
      if (J && J.index < f) ++n, (w = J.index + J[0].length);
      else break;
    }
    l = { line: n, ab: f - w };
    g += " (" + l.line + ":" + l.ab + ")";
  ...
  function q() {
    for (
      var f = m, g = z.va && z.C && new h(), l = r.charCodeAt((m += 2));
      m < pa && 10 !== l && 13 !== l && 8232 !== l && 8233 !== l;
  ...
  function C() {
    for (; m < pa; ) {
      ...
      else if (5760 <= f && Kc.test(String.fromCharCode(f))) ++m;
      else break;
    }
  }
  function U(f) {
    switch (f) {
          ...
          if (92 === l) {
            ...
            if (n)
              S && c(m - 2, "Octal literal in strict mode"),
                (g += String.fromCharCode(parseInt(n, 8))),
                (m += n.length - 1);
            else
              switch (l) {
                case 110:
      ...
      case 45:
        g = r.charCodeAt(m + 1);
        g === f
          ? 45 === g && 62 === r.charCodeAt(m + 2) && Va.test(r.slice(ia, m))
            ? ((m += 3), q(), C(), N())
            : F(Pc, 2)
          : 61 === g
          ? F(ma, 2)
      ...
      case 62:
        ...
        g === f
          ? ((l = 62 === f && 62 === r.charCodeAt(m + 2) ? 3 : 2),
            61 === r.charCodeAt(m + l) ? F(ma, l + 1) : F(Rc, l))
          : 33 === g &&
            60 === f &&
            45 === r.charCodeAt(m + 2) &&
            45 === r.charCodeAt(m + 3)
          ? ((m += 4), q(), C(), N())
          : (61 === g && (l = 61 === r.charCodeAt(m + 2) ? 3 : 2), F(Sc, l));
        return;
      case 61:
      case 33:
        61 === r.charCodeAt(m + 1)
          ? F(Tc, 61 === r.charCodeAt(m + 2) ? 3 : 2)
          : F(61 === f ? Xb : Yb, 1);
        return;
      case 126:
        return F(Yb, 1);
    ...
    switch (f) {
      ...
      case gc:
        ...
        if (x === qb)
          return (
            ...
            B(),
            hc(f, !0),
            y(f, "VariableDeclaration"),
            1 === f.fa.length && E(Za) ? ic(g, f) : pb(g, f)
          );
        f = O(!1, !0);
      ...
      case jc:
        return (
          ...
          (g.test = Da()),
          (g.da = V()),
          (g.alternate = E(kc) ? V() : null),
          y(g, "IfStatement")
        );
      case lc:
        return (
          Ea || z.Ib || c(I, "'return' outside of function"),
          B(),
          E(Z) || Wa() ? (g.K = null) : ((g.K = O()), na()),
          y(g, "ReturnStatement")
        );
      case tb:
        B();
      ...
      case nc:
        return (
          B(),
          Va.test(r.slice(ia, I)) && c(ia, "Illegal newline after throw"),
          (g.K = O()),
          na(),
          y(g, "ThrowStatement")
        );
      case oc:
        return (
          ...
          x === pc &&
            ...
            S &&
              Ya(f.Ua.name) &&
              c(f.Ua.start, "Binding " + f.Ua.name + " in strict mode"),
            G(W),
            (f.body = Fa()),
            (g.Ea = y(f, "CatchClause"))),
          (g.fb = E(qc) ? Fa() : null),
          g.Ea || g.fb || c(g.start, "Missing catch or finally clause"),
          y(g, "TryStatement")
        );
      case qb:
      ...
      default:
        ...
        if (f === sa && "Identifier" === w.type && E(Aa)) {
          ...
          H.push({ name: l, kind: x.W ? "loop" : x === tb ? "switch" : null });
          g.body = V();
          H.pop();
          g.label = w;
  ...
  function Ga(f, g) {
    ...
    return E(db)
      ? ((l = ja(f)),
        ...
        (l.bb = !0),
        G(eb),
        Ga(y(l, "MemberExpression"), g))
      : !g && E(Y)
      ? ((l = ja(f)),
        (l.callee = f),
        (l.arguments = yb(W, !1)),
        Ga(y(l, "CallExpression"), g))
      : f;
  }
  function $a() {
    switch (x) {
      ...
      case db:
        return (
          (f = L()), B(), (f.elements = yb(eb, !0, !0)), y(f, "ArrayExpression")
        );
      case za:
        f = L();
        g = !0;
        ...
        for (B(); !E(qa); ) {
          if (g) g = !1;
          else if ((G(ha), z.sb && E(qa))) break;
          var n = { key: x === Ca || x === Ta ? $a() : ba(!0) },
            w = !1;
          if (E(Aa)) {
            n.value = O(!0);
            var J = (n.kind = "init");
            ...
            for (var P = 0; P < f.h.length; ++P) {
              ...
              if (ta.key.name === n.key.name) {
                var zb =
                  J === ta.kind ||
                  (w && "init" === ta.kind) ||
                  ("init" === J && ("get" === ta.kind || "set" === ta.kind));
  ...
  var yc = {
    ...
    Vc = {
      ...
      new: wc,
      in: Za,
      instanceof: { l: "instanceof", L: 7, m: !0 },
      this: sc,
      typeof: { l: "typeof", prefix: !0, m: !0 },
      void: { l: "void", prefix: !0, m: !0 },
      delete: { l: "delete", prefix: !0, m: !0 },
    },
    db = { type: "[", m: !0 },
    eb = { type: "]" },
    za = { type: "{", m: !0 },
...
var ka = { C: !0, kc: 5 },
  ua = { configurable: !0, enumerable: !0, writable: !1 },
  v = { configurable: !0, enumerable: !1, writable: !0 },
  A = { configurable: !0, enumerable: !1, writable: !1 },
  va = { configurable: !1, enumerable: !1, writable: !1 },
  wa = { configurable: !1, enumerable: !0, writable: !0 },
  xa = { STEP_ERROR: !0 },
  Ha = { SCOPE_REFERENCE: !0 },
  Ia = { VALUE_IN_DESCRIPTOR: !0 },
  Ja = { REGEXP_TIMEOUT: !0 },
  Ka = [],
  La = null,
  Ma = null,
...
p.lb = function () {
  ...
  do {
    ...
    if (this.P)
      throw (
        ((this.value = void 0), Error("Getter not supported in this context"))
      );
    if (this.Ka)
      throw (
        ((this.value = void 0), Error("Setter not supported in this context"))
      );
...
function Ab(a, b) {
  ...
  c = function (e, h) {
    ...
    null !== h &&
      ...
      (h instanceof D
        ? (k.F = Ob(a, h))
        : K(a, a.j, "CreateListFromArrayLike called on non-object"));
    k.eb = !1;
  };
  M(a, a.O, "apply", c);
  c = function (e) {
...
function Bb(a, b) {
  function d(e) {
    (void 0 !== e && null !== e) ||
      K(a, a.j, "Cannot convert '" + e + "' to object");
  }
  var c = function (e) {
  ...
  c = function (e) {
    ...
    e instanceof D ||
      K(a, a.j, "Object prototype may only be an Object or null, not " + e);
    return a.s(e);
  };
  ...
  c = function (e, h, k) {
    h = String(h);
    e instanceof D ||
      K(a, a.j, "Object.defineProperty called on non-object: " + e);
    k instanceof D || K(a, a.j, "Property description must be an object");
    !e.preventExtensions ||
      h in e.h ||
      K(a, a.j, "Can't define property '" + h + "', object is not extensible");
    a.g(e, h, Ia, k.h);
    return e;
  };
  ...
  c = function (e, h) {
    e instanceof D ||
      K(a, a.j, "Object.getOwnPropertyDescriptor called on non-object: " + e);
    h = String(h);
    if (h in e.h) {
      ...
      h = a.s(a.M);
      q || e
        ? (a.g(h, "get", q), a.g(h, "set", e))
        : (a.g(h, "value", k.value), a.g(h, "writable", k.writable));
...
function Cb(a, b) {
  var d = function (c) {
    ...
    if (1 === arguments.length && "number" === typeof h)
      isNaN(Pa(h)) && K(a, a.ob, "Invalid array length: " + h),
        (e.h.length = h);
    else {
  ...
  a.g(a.La, "length", 0, { configurable: !1, enumerable: !1, writable: !0 });
  a.La.H = "Array";
  a.ba.push(
    "(function() {",
...
function Db(a, b) {
  ...
  d = function (c, e) {
    ...
    if (2 === a.REGEXP_MODE)
      if (La)
        (c = Ec(a, "string.match(regexp)", { string: h, regexp: c }, c, e)),
          c !== Ja && e(c && Bc(a, c));
      else {
        var k = a.ha(),
          q = Fc(a, c, k, e);
  ...
  d = function (c, e) {
    ...
    if (2 === a.REGEXP_MODE)
      if (La)
        (c = Ec(a, "string.search(regexp)", { string: h, regexp: c }, c, e)),
          c !== Ja && e(c);
      else {
        var k = a.ha(),
          q = Fc(a, c, k, e);
...
function Hb(a, b) {
  ...
  d = function (c, e) {
    ...
    if (2 === a.REGEXP_MODE)
      if (La)
        (c = Ec(a, "regexp.exec(string)", { string: c, regexp: k }, k, e)),
          c !== Ja && (a.g(this, "lastIndex", k.lastIndex), e(h(c)));
      else {
        var q = a.ha(),
          C = Fc(a, k, q, e),
          U = this;
...
function Kb(a, b) {
  ...
  b = function (c, e, h) {
    e && "Function" === e.H
      ? K(a, a.j, "Function replacer on JSON.stringify not supported")
      : e && "Array" === e.H
      ? ((e = Ob(a, e)),
...
function Ic(a, b, d) {
  ...
  for (var c = a.o.length - 1; 0 <= c; c--) {
    var e = a.o[c],
      h = e.node;
    "CallExpression" === h.type &&
      (e = e.U) &&
      d.length &&
      (d[d.length - 1].Ob = a.G(e, "name"));
    !h.X || (d.length && "CallExpression" !== h.type) || d.push({ Nb: h.X });
  }
  c = String(a.G(b, "name"));
...
function Ec(a, b, d, c, e) {
  var h = { timeout: a.REGEXP_THREAD_TIMEOUT };
  try {
...
function Zc(a, b, d) {
  var c = a.s(a.Z);
  d
    ? ((d = a.s(a.M)), a.g(c, "prototype", d, v), a.g(d, "constructor", c, v))
    : (c.Ab = !0);
  a.g(c, "length", b, A);
  c.H = "Function";
  return c;
...
function Bc(a, b) {
  for (
    var d = Cc(a), c = Object.getOwnPropertyNames(b), e = 0;
    e < c.length;
    e++
  )
    a.g(d, c[e], b[c[e]]);
...
p.G = function (a, b) {
  ...
  b = String(b);
  (void 0 !== a && null !== a) ||
    K(this, this.j, "Cannot read property '" + b + "' of " + a);
  ...
  do if (a.h && b in a.h) return (d = a.V[b]) ? ((this.P = !0), d) : a.h[b];
  while ((a = Ac(this, a)));
};
function $c(a, b, d) {
  if (!(b instanceof D))
...
p.g = function (a, b, d, c) {
  ...
  b = String(b);
  (void 0 !== a && null !== a) ||
    K(this, this.j, "Cannot set property '" + b + "' of " + a);
  if ("object" === typeof a && !(a instanceof D))
    throw TypeError("Expecting native value or pseudo object");
  c &&
    ("get" in c || "set" in c) &&
  ...
  if (a instanceof D) {
    ...
    if (!a.preventExtensions || b in a.h)
      if (c) {
        ...
        "writable" in c &&
          ((e.writable = c.writable), delete a.V[b], delete a.Y[b]);
        "value" in c
          ? ((e.value = c.value), delete a.V[b], delete a.Y[b])
          : d !== Ia && ((e.value = d), delete a.V[b], delete a.Y[b]);
        try {
...
function Ra(a, b, d) {
  ...
  for (k in c)
    !0 === c[k]
      ? a.g(d.object, k, void 0, wa)
      : a.g(d.object, k, Nb(a, c[k], d), wa);
  return c;
}
function zc(a) {
...
function hd(a, b, d, c) {
  ...
  Q(a, d, a.D)
    ? ((b = {
      ...
      (c = String(a.G(d, "name"))),
      (e = a.G(d, "message").valueOf()),
      (b = (b[c] || Error)(e)),
      (b.stack = String(a.G(d, "stack"))))
    : (b = String(d));
  a.value = b;
  throw b;
}
...
t.prototype.stepArrayExpression = function (a, b, d) {
  ...
  var c = b.A || 0;
  b.Oa
    ? (this.g(b.Oa, c, b.value), c++)
    : ((b.Oa = Cc(this)), (b.Oa.h.length = d.length));
  for (; c < d.length; ) {
...
t.prototype.stepAssignmentExpression = function (a, b, d) {
  ...
  if (b.ta) a.pop(), (a[a.length - 1].value = b.ib);
  else {
    var c = b.ma,
      e = b.value;
    switch (d.operator) {
...
t.prototype.stepBinaryExpression = function (a, b, d) {
  ...
  switch (d.operator) {
    ...
    case "in":
      b instanceof D ||
        K(this, this.j, "'in' expects an object, not '" + b + "'");
      d = $c(this, b, c);
      break;
    case "instanceof":
      Q(this, b, this.O) ||
        K(this, this.j, "'instanceof' expects an object, not '" + b + "'");
...
t.prototype.stepCallExpression = function (a, b, d) {
  ...
  if (!b.Qa) {
    ...
    if ("NewExpression" === d.type) {
      (e instanceof D && !e.Ab) ||
        K(this, this.j, R(this, d.callee) + " is not a constructor");
      if (e === this.qa) b.B = Cc(this);
      else {
        var h = e.h.prototype;
  ...
  if (b.eb)
    ...
    if (e.eval)
      if (((e = b.F[0]), "string" !== typeof e)) b.value = e;
      else {
        try {
...
t.prototype.stepDoWhileStatement = function (a, b, d) {
  ...
  if (!b.value) a.pop();
  else if (d.body) return (b.ga = !1), (b.W = !0), new u(d.body, b.scope);
};
...
t.prototype.stepForInStatement = function (a, b, d) {
  ...
  if (!b.wb)
    ...
    else return (b.pa = null), (b = new u(a, b.scope)), (b.sa = !0), b;
  b.pa || (b.pa = b.value);
...
t.prototype.stepForStatement = function (a, b, d) {
  switch (b.na) {
    ...
    case 2:
      ...
      else return (b.W = !0), new u(d.body, b.scope);
      break;
    case 3:
...
t.prototype.stepIdentifier = function (a, b, d) {
  a.pop();
  if (b.sa) a[a.length - 1].value = [Ha, d.name];
  else {
    b = dd(this, d.name);
...
t.prototype.stepLogicalExpression = function (a, b, d) {
  ...
  if (!b.ja) return (b.ja = !0), new u(d.left, b.scope);
  if (b.Da) a.pop(), (a[a.length - 1].value = b.value);
  else if (
    ("&&" === d.operator && !b.value) ||
    ("||" === d.operator && b.value)
  )
    a.pop(), (a[a.length - 1].value = b.value);
  else return (b.Da = !0), new u(d.right, b.scope);
};
t.prototype.stepMemberExpression = function (a, b, d) {
  if (!b.Ca) return (b.Ca = !0), new u(d.object, b.scope);
  if (d.bb)
    if (b.Vb) d = b.value;
    else return (b.u = b.value), (b.Vb = !0), new u(d.Wa, b.scope);
  else (b.u = b.value), (d = d.Wa.name);
  a.pop();
  if (b.sa) a[a.length - 1].value = [b.u, d];
  else {
    d = this.G(b.u, d);
...
t.prototype.stepObjectExpression = function (a, b, d) {
  ...
  if (e) {
    var k = e.key;
    if ("Identifier" === k.type) h = k.name;
    else if ("Literal" === k.type) h = k.value;
...
t.prototype.stepThrowStatement = function (a, b, d) {
  if (b.ka) K(this, b.value);
  else return (b.ka = !0), new u(d.K, b.scope);
};
t.prototype.stepTryStatement = function (a, b, d) {
  ...
  if (b.ea && 4 === b.ea.type && !b.Tb && d.Ea)
    return (
      (b.Tb = !0),
      (a = cd(this, b.scope)),
      this.g(a.object, d.Ea.Ua.name, b.ea.value),
      (b.ea = void 0),
      new u(d.Ea.body, a)
    );
